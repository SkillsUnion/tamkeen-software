...
1. Use Promises as an alternative to callback functions
3. Apply `.catch` run specified logic when our programs encounter errors in promises
4. Use `Promise.all` to wait on multiple promises concurrently instead of sequentially
